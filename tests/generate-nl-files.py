...
generate_nl_file('jobassign0', '$.mod', 'jobassign.dat')
generate_nl_file('jobassign1', '$.mod', 'jobassign.dat')
generate_nl_file('jobassign2', '$.mod', 'jobassign.dat')
generate_nl_file('jobassign3', '$.mod', 'jobassign.dat')
