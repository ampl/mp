...
set(CPLEX_STUDIO_DIR CPLEX_STUDIO_DIR-NOTFOUND CACHE PATH
...
if (NOT CPLEX_STUDIO_DIR)
  foreach (dir ${CPLEX_ILOG_DIRS})
    ...
    if (CPLEX_STUDIO_DIRS)
      ...
      message(STATUS "Found CPLEX Studio in ${CPLEX_STUDIO_DIR}")
      break ()
    endif ()
  endforeach ()
endif ()
...
macro(find_win_cplex_library config path_suffixes)
  foreach (s ${path_suffixes})
    ...
    if (CPLEX_LIBRARY_CANDIDATES)
      ...
      set(CPLEX_LIBRARY ${CPLEX_LIBRARY} ${config} ${CPLEX_LIB}
