...
#ifdef ALGAFTERCROSSOVER
    MPD( AddSolverOption_MergeDuplicates("bar:algaftercrossover ALGAFTERCROSSOVER",
      ...
      "\n- (3)  Primal simplex."
      "\n- (4)  Concurrent.",
      ALGAFTERCROSSOVER, INT_MIN, INT_MAX) );
#endif  // ifdef ALGAFTERCROSSOVER

#ifdef ALGAFTERNETWORK
    MPD( AddSolverOption_MergeDuplicates("lp:algafternetwork ALGAFTERNETWORK",
      ...
      "\n- (2)  Dual simplex."
      "\n- (3)  Primal simplex.",
      ALGAFTERNETWORK, INT_MIN, INT_MAX) );
#endif  // ifdef ALGAFTERNETWORK

#ifdef ALTERNATIVEREDCOSTS
    MPD( AddSolverOption_MergeDuplicates("pre:alternativeredcosts ALTERNATIVEREDCOSTS",
      ...
      ALTERNATIVEREDCOSTS, INT_MIN, INT_MAX) );
#endif  // ifdef ALTERNATIVEREDCOSTS

#ifdef AUTOCUTTING
    MPD( AddSolverOption_MergeDuplicates("cut:autocutting AUTOCUTTING",
      ...
      "\n- (0)  Disabled."
      "\n- (1)  Enabled. ",
      AUTOCUTTING, INT_MIN, INT_MAX) );
#endif  // ifdef AUTOCUTTING

#ifdef AUTOPERTURB
    MPD( AddSolverOption_MergeDuplicates("lp:autoperturb AUTOPERTURB",
      ...
      AUTOPERTURB, INT_MIN, INT_MAX) );
#endif  // ifdef AUTOPERTURB

#ifdef AUTOSCALING
    MPD( AddSolverOption_MergeDuplicates("num:autoscaling AUTOSCALING",
      ...
      AUTOSCALING, INT_MIN, INT_MAX) );
#endif  // ifdef AUTOSCALING

#ifdef BACKGROUNDMAXTHREADS
    MPD( AddSolverOption_MergeDuplicates("pre:backgroundmaxthreads BACKGROUNDMAXTHREADS",
      ...
      BACKGROUNDMAXTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef BACKGROUNDMAXTHREADS

#ifdef BACKGROUNDSELECT
    MPD( AddSolverOption_MergeDuplicates("heur:backgroundselect BACKGROUNDSELECT",
      ...
      BACKGROUNDSELECT, INT_MIN, INT_MAX) );
#endif  // ifdef BACKGROUNDSELECT

#ifdef BACKTRACK
    MPD( AddSolverOption_MergeDuplicates("mip:backtrack BACKTRACK",
      ...
      BACKTRACK, INT_MIN, INT_MAX) );
#endif  // ifdef BACKTRACK

#ifdef BACKTRACKTIE
    MPD( AddSolverOption_MergeDuplicates("mip:backtracktie BACKTRACKTIE",
      ...
      "\n- (11)  Combination of 2 and 4."
      "\n- (12)  Combination of 3 and 4.",
      BACKTRACKTIE, INT_MIN, INT_MAX) );
#endif  // ifdef BACKTRACKTIE

#ifdef BARALG
    MPD( AddSolverOption_MergeDuplicates("bar:alg BARALG",
      ...
      BARALG, INT_MIN, INT_MAX) );
#endif  // ifdef BARALG

#ifdef BARCORES
    MPD( AddSolverOption_MergeDuplicates("bar:cores BARCORES",
      ...
      BARCORES, INT_MIN, INT_MAX) );
#endif  // ifdef BARCORES

#ifdef BARCRASH
    MPD( AddSolverOption_MergeDuplicates("bar:crash BARCRASH",
      ...
      BARCRASH, INT_MIN, INT_MAX) );
#endif  // ifdef BARCRASH

#ifdef BARDUALSTOP
    MPD( AddSolverOption_MergeDuplicates("bar:dualstop BARDUALSTOP",
      ...
      BARDUALSTOP, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARDUALSTOP

#ifdef BARFAILITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("bar:failiterlimit BARFAILITERLIMIT",
      ...
      BARFAILITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef BARFAILITERLIMIT

#ifdef BARFREESCALE
    MPD( AddSolverOption_MergeDuplicates("bar:freescale BARFREESCALE",
      "Defines how the barrier algorithm scales free variables."
      "\n\nDefault: 1e-6",
      BARFREESCALE, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARFREESCALE

#ifdef BARGAPSTOP
    MPD( AddSolverOption_MergeDuplicates("bar:gapstop BARGAPSTOP",
      ...
      BARGAPSTOP, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARGAPSTOP

#ifdef BARGAPTARGET
    MPD( AddSolverOption_MergeDuplicates("bar:gaptarget BARGAPTARGET",
      ...
      BARGAPTARGET, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARGAPTARGET

#ifdef BARHGEXTRAPOLATE
    MPD( AddSolverOption_MergeDuplicates("pdhg:barhgextrapolate BARHGEXTRAPOLATE",
      ...
      "\n\nDefault:                          0.15                 ",
      BARHGEXTRAPOLATE, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARHGEXTRAPOLATE

#ifdef BARHGGPU
    MPD( AddSolverOption_MergeDuplicates("pdhg:barhggpu BARHGGPU",
      ...
      "\n- (0)  Do not use a GPU."
      "\n- (1)  Use the GPU.",
      BARHGGPU, INT_MIN, INT_MAX) );
#endif  // ifdef BARHGGPU

#ifdef BARHGGPUBLOCKSIZE
    MPD( AddSolverOption_MergeDuplicates("pdhg:barhggpublocksize BARHGGPUBLOCKSIZE",
      "             The size of CUDA blocks to use for the GPU calculations. 		"
      "\n\nDefault:  			256 		",
      BARHGGPUBLOCKSIZE, INT_MIN, INT_MAX) );
#endif  // ifdef BARHGGPUBLOCKSIZE

#ifdef BARHGMAXRESTARTS
    MPD( AddSolverOption_MergeDuplicates("pdhg:barhgmaxrestarts BARHGMAXRESTARTS",
      ...
      "\n\nDefault:                  1250         ",
      BARHGMAXRESTARTS, INT_MIN, INT_MAX) );
#endif  // ifdef BARHGMAXRESTARTS

#ifdef BARHGOPS
    MPD( AddSolverOption_MergeDuplicates("pdhg:barhgops BARHGOPS",
      ...
      BARHGOPS, INT_MIN, INT_MAX) );
#endif  // ifdef BARHGOPS

#ifdef BARHGPRECISION
    MPD( AddSolverOption_MergeDuplicates("pdhg:barhgprecision BARHGPRECISION",
      ...
      BARHGPRECISION, INT_MIN, INT_MAX) );
#endif  // ifdef BARHGPRECISION

#ifdef BARHGRELTOL
    MPD( AddSolverOption_MergeDuplicates("pdhg:barhgreltol BARHGRELTOL",
      "                         Relative feasibility tolerance for the hybrid gradient algorithm.                 "
      "\n\nDefault:                          0, determined automatically.                 ",
      BARHGRELTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARHGRELTOL

#ifdef BARINDEFLIMIT
    MPD( AddSolverOption_MergeDuplicates("bar:indeflimit BARINDEFLIMIT",
      ...
      "\n\nDefault: 15",
      BARINDEFLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef BARINDEFLIMIT

#ifdef BARITERATIVE
    MPD( AddSolverOption_MergeDuplicates("bar:iterative BARITERATIVE",
      ...
      BARITERATIVE, INT_MIN, INT_MAX) );
#endif  // ifdef BARITERATIVE

#ifdef BARITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("bar:iterlimit BARITERLIMIT",
      ...
      "\n\nDefault: 500",
      BARITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef BARITERLIMIT

#ifdef BARKERNEL
    MPD( AddSolverOption_MergeDuplicates("bar:kernel BARKERNEL",
      ...
      BARKERNEL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARKERNEL

#ifdef BARLARGEBOUND
    MPD( AddSolverOption_MergeDuplicates("bar:largebound BARLARGEBOUND",
      "Threshold for the barrier to handle large bounds."
      "\n\nDefault: 0",
      BARLARGEBOUND, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARLARGEBOUND

#ifdef BAROBJPERTURB
    MPD( AddSolverOption_MergeDuplicates("bar:objperturb BAROBJPERTURB",
      ...
      BAROBJPERTURB, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BAROBJPERTURB

#ifdef BAROBJSCALE
    MPD( AddSolverOption_MergeDuplicates("bar:objscale BAROBJSCALE",
      ...
      BAROBJSCALE, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BAROBJSCALE

#ifdef BARORDER
    MPD( AddSolverOption_MergeDuplicates("bar:order BARORDER",
      ...
      BARORDER, INT_MIN, INT_MAX) );
#endif  // ifdef BARORDER

#ifdef BARORDERTHREADS
    MPD( AddSolverOption_MergeDuplicates("bar:orderthreads BARORDERTHREADS",
      ...
      BARORDERTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef BARORDERTHREADS

#ifdef BAROUTPUT
    MPD( AddSolverOption_MergeDuplicates("bar:output BAROUTPUT",
      ...
      "\n- (0)  No output."
      "\n- (1)  At each iteration.",
      BAROUTPUT, INT_MIN, INT_MAX) );
#endif  // ifdef BAROUTPUT

#ifdef BARPERTURB
    MPD( AddSolverOption_MergeDuplicates("bar:perturb BARPERTURB",
      ...
      "\n\nDefault: 0",
      BARPERTURB, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARPERTURB

#ifdef BARPRESOLVEOPS
    MPD( AddSolverOption_MergeDuplicates("bar:presolveops BARPRESOLVEOPS",
      ...
      BARPRESOLVEOPS, INT_MIN, INT_MAX) );
#endif  // ifdef BARPRESOLVEOPS

#ifdef BARPRIMALSTOP
    MPD( AddSolverOption_MergeDuplicates("bar:primalstop BARPRIMALSTOP",
      ...
      BARPRIMALSTOP, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARPRIMALSTOP

#ifdef BARREFITER
    MPD( AddSolverOption_MergeDuplicates("bar:refiter BARREFITER",
      ...
      "\n\nDefault: 0",
      BARREFITER, INT_MIN, INT_MAX) );
#endif  // ifdef BARREFITER

#ifdef BARREGULARIZE
    MPD( AddSolverOption_MergeDuplicates("bar:regularize BARREGULARIZE",
      ...
      BARREGULARIZE, INT_MIN, INT_MAX) );
#endif  // ifdef BARREGULARIZE

#ifdef BARRHSSCALE
    MPD( AddSolverOption_MergeDuplicates("bar:rhsscale BARRHSSCALE",
      ...
      BARRHSSCALE, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARRHSSCALE

#ifdef BARSOLUTION
    MPD( AddSolverOption_MergeDuplicates("bar:solution BARSOLUTION",
      ...
      BARSOLUTION, INT_MIN, INT_MAX) );
#endif  // ifdef BARSOLUTION

#ifdef BARSTART
    MPD( AddSolverOption_MergeDuplicates("bar:start BARSTART",
      ...
      BARSTART, INT_MIN, INT_MAX) );
#endif  // ifdef BARSTART

#ifdef BARSTARTWEIGHT
    MPD( AddSolverOption_MergeDuplicates("bar:startweight BARSTARTWEIGHT",
      ...
      "\n\nDefault: 0.85",
      BARSTARTWEIGHT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARSTARTWEIGHT

#ifdef BARSTEPSTOP
    MPD( AddSolverOption_MergeDuplicates("bar:stepstop BARSTEPSTOP",
      ...
      "\n\nDefault: 1.0E-16",
      BARSTEPSTOP, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BARSTEPSTOP

#ifdef BARTHREADS
    MPD( AddSolverOption_MergeDuplicates("bar:threads BARTHREADS",
      ...
      BARTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef BARTHREADS

#ifdef BIGM
    MPD( AddSolverOption_MergeDuplicates("lp:bigm BIGM",
      "The infeasibility penalty used if the "Big M" method is implemented. "
      "\n\nDefault: Dependent on the matrix characteristics.",
      BIGM, -DBL_MAX, DBL_MAX) );
#endif  // ifdef BIGM

#ifdef BIGMMETHOD
    MPD( AddSolverOption_MergeDuplicates("lp:bigmmethod BIGMMETHOD",
      ...
      BIGMMETHOD, INT_MIN, INT_MAX) );
#endif  // ifdef BIGMMETHOD

#ifdef BRANCHCHOICE
    MPD( AddSolverOption_MergeDuplicates("mip:branchchoice BRANCHCHOICE",
      ...
      BRANCHCHOICE, INT_MIN, INT_MAX) );
#endif  // ifdef BRANCHCHOICE

#ifdef BRANCHDISJ
    MPD( AddSolverOption_MergeDuplicates("mip:branchdisj BRANCHDISJ",
      ...
      BRANCHDISJ, INT_MIN, INT_MAX) );
#endif  // ifdef BRANCHDISJ

#ifdef BRANCHSTRUCTURAL
    MPD( AddSolverOption_MergeDuplicates("mip:branchstructural BRANCHSTRUCTURAL",
      ...
      "\n- (0)  Disabled."
      "\n- (1)  Enabled.",
      BRANCHSTRUCTURAL, INT_MIN, INT_MAX) );
#endif  // ifdef BRANCHSTRUCTURAL

#ifdef BREADTHFIRST
    MPD( AddSolverOption_MergeDuplicates("mip:breadthfirst BREADTHFIRST",
      "The number of nodes to include in the best-first search before switching to the local first search (NODESELECTION=4)."
      "\n\nDefault: 11",
      BREADTHFIRST, INT_MIN, INT_MAX) );
#endif  // ifdef BREADTHFIRST

#ifdef CACHESIZE
    MPD( AddSolverOption_MergeDuplicates("sys:cachesize CACHESIZE",
      ...
      "\n\nDefault: -1",
      CACHESIZE, INT_MIN, INT_MAX) );
#endif  // ifdef CACHESIZE

#ifdef CALLBACKCHECKTIMEDELAY
    MPD( AddSolverOption_MergeDuplicates("tech:callbackchecktimedelay CALLBACKCHECKTIMEDELAY",
      ...
      CALLBACKCHECKTIMEDELAY, INT_MIN, INT_MAX) );
#endif  // ifdef CALLBACKCHECKTIMEDELAY

#ifdef CALLBACKCHECKTIMEWORKDELAY
    MPD( AddSolverOption_MergeDuplicates("tech:callbackchecktimeworkdelay CALLBACKCHECKTIMEWORKDELAY",
      ...
      CALLBACKCHECKTIMEWORKDELAY, -DBL_MAX, DBL_MAX) );
#endif  // ifdef CALLBACKCHECKTIMEWORKDELAY

#ifdef CALLBACKFROMMAINTHREAD
    MPD( AddSolverOption_MergeDuplicates("tech:callbackfrommainthread CALLBACKFROMMAINTHREAD",
      ...
      CALLBACKFROMMAINTHREAD, INT_MIN, INT_MAX) );
#endif  // ifdef CALLBACKFROMMAINTHREAD

#ifdef CHECKINPUTDATA
    MPD( AddSolverOption_MergeDuplicates("prob:checkinputdata CHECKINPUTDATA",
      "Check input arrays for bad data."
      "\n\n"
      "Values (default: 1 (on)):\n"
      "\n- (0)  Do not check."
      "\n- (1)  Check input arrays.",
      CHECKINPUTDATA, INT_MIN, INT_MAX) );
#endif  // ifdef CHECKINPUTDATA

#ifdef CHOLESKYALG
    MPD( AddSolverOption_MergeDuplicates("bar:choleskyalg CHOLESKYALG",
      ...
      CHOLESKYALG, INT_MIN, INT_MAX) );
#endif  // ifdef CHOLESKYALG

#ifdef CHOLESKYTOL
    MPD( AddSolverOption_MergeDuplicates("bar:choleskytol CHOLESKYTOL",
      ...
      "\n\nDefault: 1.0E-15",
      CHOLESKYTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef CHOLESKYTOL

#ifdef CLAMPING
    MPD( AddSolverOption_MergeDuplicates("sol:clamping CLAMPING",
      ...
      CLAMPING, INT_MIN, INT_MAX) );
#endif  // ifdef CLAMPING

#ifdef COMPUTE
    MPD( AddSolverOption_MergeDuplicates("tech:compute COMPUTE",
      ...
      COMPUTE, INT_MIN, INT_MAX) );
#endif  // ifdef COMPUTE

#ifdef COMPUTEEXECSERVICE
    MPD( AddSolverOption_MergeDuplicates("tech:computeexecservice COMPUTEEXECSERVICE",
      "Selects the Insight execution service that will be used for solving remote optimizations."
      "\n\nDefault: Empty string",
      COMPUTEEXECSERVICE) );
#endif  // ifdef COMPUTEEXECSERVICE

#ifdef COMPUTEJOBPRIORITY
    MPD( AddSolverOption_MergeDuplicates("tech:computejobpriority COMPUTEJOBPRIORITY",
      "Selects the priority that will be used for remote optimization jobs."
      "\n\nDefault: 0",
      COMPUTEJOBPRIORITY, INT_MIN, INT_MAX) );
#endif  // ifdef COMPUTEJOBPRIORITY

#ifdef COMPUTELOG
    MPD( AddSolverOption_MergeDuplicates("tech:computelog COMPUTELOG",
      ...
      COMPUTELOG, INT_MIN, INT_MAX) );
#endif  // ifdef COMPUTELOG

#ifdef CONCURRENTTHREADS
    MPD( AddSolverOption_MergeDuplicates("tech:concurrentthreads CONCURRENTTHREADS",
      " Determines the number of threads used by the concurrent solver. "
      "\n\n"
      "Values (default: -1):\n"
      "\n- (-1)  Determined automatically"
      "\n- (>0)  Number of threads to use.",
      CONCURRENTTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef CONCURRENTTHREADS

#ifdef CONFLICTCUTS
    MPD( AddSolverOption_MergeDuplicates("mip:conflictcuts CONFLICTCUTS",
      ...
      CONFLICTCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef CONFLICTCUTS

#ifdef CORESPERCPU
    MPD( AddSolverOption_MergeDuplicates("sys:corespercpu CORESPERCPU",
      ...
      "\n\nDefault: -1",
      CORESPERCPU, INT_MIN, INT_MAX) );
#endif  // ifdef CORESPERCPU

#ifdef COVERCUTS
    MPD( AddSolverOption_MergeDuplicates("pre:covercuts COVERCUTS",
      ...
      COVERCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef COVERCUTS

#ifdef CPIALPHA
    MPD( AddSolverOption_MergeDuplicates("tech:cpialpha CPIALPHA",
      "decay term for confined primal integral computation."
      "\n\nDefault: 0",
      CPIALPHA, -DBL_MAX, DBL_MAX) );
#endif  // ifdef CPIALPHA

#ifdef CPUPLATFORM
    MPD( AddSolverOption_MergeDuplicates("sys:cpuplatform CPUPLATFORM",
      ...
      CPUPLATFORM, INT_MIN, INT_MAX) );
#endif  // ifdef CPUPLATFORM

#ifdef CPUTIME
    MPD( AddSolverOption_MergeDuplicates("sys:cputime CPUTIME",
      ...
      "\n- (0)  Use elapsed time."
      "\n- (1)  Use process time.",
      CPUTIME, INT_MIN, INT_MAX) );
#endif  // ifdef CPUTIME

#ifdef CRASH
    MPD( AddSolverOption_MergeDuplicates("lp:crash CRASH",
      ...
      CRASH, INT_MIN, INT_MAX) );
#endif  // ifdef CRASH

#ifdef CROSSOVER
    MPD( AddSolverOption_MergeDuplicates("bar:crossover CROSSOVER",
      ...
      CROSSOVER, INT_MIN, INT_MAX) );
#endif  // ifdef CROSSOVER

#ifdef CROSSOVERACCURACYTOL
    MPD( AddSolverOption_MergeDuplicates("bar:crossoveraccuracytol CROSSOVERACCURACYTOL",
      ...
      "\n\nDefault: 1e-6",
      CROSSOVERACCURACYTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef CROSSOVERACCURACYTOL

#ifdef CROSSOVERITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("bar:crossoveriterlimit CROSSOVERITERLIMIT",
      ...
      "\n\nDefault: 2147483647",
      CROSSOVERITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef CROSSOVERITERLIMIT

#ifdef CROSSOVEROPS
    MPD( AddSolverOption_MergeDuplicates("bar:crossoverops CROSSOVEROPS",
      ...
      CROSSOVEROPS, INT_MIN, INT_MAX) );
#endif  // ifdef CROSSOVEROPS

#ifdef CROSSOVERTHREADS
    MPD( AddSolverOption_MergeDuplicates("bar:crossoverthreads CROSSOVERTHREADS",
      ...
      CROSSOVERTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef CROSSOVERTHREADS

#ifdef CUTDEPTH
    MPD( AddSolverOption_MergeDuplicates("mip:cutdepth CUTDEPTH",
      ...
      "\n\nDefault: -1 — determined automatically.",
      CUTDEPTH, INT_MIN, INT_MAX) );
#endif  // ifdef CUTDEPTH

#ifdef CUTFACTOR
    MPD( AddSolverOption_MergeDuplicates("mip:cutfactor CUTFACTOR",
      ...
      CUTFACTOR, -DBL_MAX, DBL_MAX) );
#endif  // ifdef CUTFACTOR

#ifdef CUTFREQ
    MPD( AddSolverOption_MergeDuplicates("mip:cutfreq CUTFREQ",
      ...
      "\n\nDefault: -1 — determined automatically.",
      CUTFREQ, INT_MIN, INT_MAX) );
#endif  // ifdef CUTFREQ

#ifdef CUTSELECT
    MPD( AddSolverOption_MergeDuplicates("pre:cutselect CUTSELECT",
      ...
      "\n- (20)  Farkas cuts.",
      CUTSELECT, INT_MIN, INT_MAX) );
#endif  // ifdef CUTSELECT

#ifdef CUTSTRATEGY
    MPD( AddSolverOption_MergeDuplicates("mip:cutstrategy CUTSTRATEGY",
      ...
      CUTSTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef CUTSTRATEGY

#ifdef DEFAULTALG
    MPD( AddSolverOption_MergeDuplicates("mip:defaultalg DEFAULTALG",
      ...
      DEFAULTALG, INT_MIN, INT_MAX) );
#endif  // ifdef DEFAULTALG

#ifdef DENSECOLLIMIT
    MPD( AddSolverOption_MergeDuplicates("bar:densecollimit DENSECOLLIMIT",
      ...
      "\n\nDefault: 0 — determined automatically.",
      DENSECOLLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef DENSECOLLIMIT

#ifdef DETERMINISTIC
    MPD( AddSolverOption_MergeDuplicates("tech:deterministic DETERMINISTIC",
      ...
      DETERMINISTIC, INT_MIN, INT_MAX) );
#endif  // ifdef DETERMINISTIC

#ifdef DETERMINISTICLOG
    MPD( AddSolverOption_MergeDuplicates("tech:deterministiclog DETERMINISTICLOG",
      ...
      DETERMINISTICLOG, INT_MIN, INT_MAX) );
#endif  // ifdef DETERMINISTICLOG

#ifdef DUALGRADIENT
    MPD( AddSolverOption_MergeDuplicates("lp:dualgradient DUALGRADIENT",
      ...
      "\n- (3)  Sparse Devex.",
      DUALGRADIENT, INT_MIN, INT_MAX) );
#endif  // ifdef DUALGRADIENT

#ifdef DUALIZE
    MPD( AddSolverOption_MergeDuplicates("lp:dualize DUALIZE",
      ...
      DUALIZE, INT_MIN, INT_MAX) );
#endif  // ifdef DUALIZE

#ifdef DUALIZEOPS
    MPD( AddSolverOption_MergeDuplicates("lp:dualizeops DUALIZEOPS",
      ...
      DUALIZEOPS, INT_MIN, INT_MAX) );
#endif  // ifdef DUALIZEOPS

#ifdef DUALPERTURB
    MPD( AddSolverOption_MergeDuplicates("lp:dualperturb DUALPERTURB",
      ...
      "\n\nDefault: -1 — determined automatically. ",
      DUALPERTURB, -DBL_MAX, DBL_MAX) );
#endif  // ifdef DUALPERTURB

#ifdef DUALSTRATEGY
    MPD( AddSolverOption_MergeDuplicates("lp:dualstrategy DUALSTRATEGY",
      ...
      DUALSTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef DUALSTRATEGY

#ifdef DUALTHREADS
    MPD( AddSolverOption_MergeDuplicates("tech:dualthreads DUALTHREADS",
      ...
      "\n\nDefault: -1 (determined by the THREADS control)",
      DUALTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef DUALTHREADS

#ifdef EIGENVALUETOL
    MPD( AddSolverOption_MergeDuplicates("qp:eigenvaluetol EIGENVALUETOL",
      ...
      "\n\nDefault: 1E-6",
      EIGENVALUETOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef EIGENVALUETOL

#ifdef ELIMFILLIN
    MPD( AddSolverOption_MergeDuplicates("pre:elimfillin ELIMFILLIN",
      "Amount of fill-in allowed when performing an elimination in presolve ."
      "\n\nDefault: 7",
      ELIMFILLIN, INT_MIN, INT_MAX) );
#endif  // ifdef ELIMFILLIN

#ifdef ELIMTOL
    MPD( AddSolverOption_MergeDuplicates("pre:elimtol ELIMTOL",
      "The Markowitz tolerance for the elimination phase of the presolve."
      "\n\nDefault: 0.001",
      ELIMTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef ELIMTOL

#ifdef ESCAPENAMES
    MPD( AddSolverOption_MergeDuplicates("tech:escapenames ESCAPENAMES",
      ...
      ESCAPENAMES, INT_MIN, INT_MAX) );
#endif  // ifdef ESCAPENAMES

#ifdef ETATOL
    MPD( AddSolverOption_MergeDuplicates("sim:etatol ETATOL",
      ...
      "\n\nDefault: 1.0E-13",
      ETATOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef ETATOL

#ifdef EXTRACOLS
    MPD( AddSolverOption_MergeDuplicates("prob:extracols EXTRACOLS",
      ...
      "\n\nDefault: 0",
      EXTRACOLS, INT_MIN, INT_MAX) );
#endif  // ifdef EXTRACOLS

#ifdef EXTRAELEMS
    MPD( AddSolverOption_MergeDuplicates("prob:extraelems EXTRAELEMS",
      ...
      EXTRAELEMS, INT_MIN, INT_MAX) );
#endif  // ifdef EXTRAELEMS

#ifdef EXTRAMIPENTS
    MPD( AddSolverOption_MergeDuplicates("prob:extramipents EXTRAMIPENTS",
      "The initial number of extra MIP entities to allow for."
      "\n\nDefault: 0",
      EXTRAMIPENTS, INT_MIN, INT_MAX) );
#endif  // ifdef EXTRAMIPENTS

#ifdef EXTRAROWS
    MPD( AddSolverOption_MergeDuplicates("prob:extrarows EXTRAROWS",
      ...
      "\n\nDefault: 0",
      EXTRAROWS, INT_MIN, INT_MAX) );
#endif  // ifdef EXTRAROWS

#ifdef EXTRASETELEMS
    MPD( AddSolverOption_MergeDuplicates("prob:extrasetelems EXTRASETELEMS",
      ...
      "\n\nDefault: 0",
      EXTRASETELEMS, INT_MIN, INT_MAX) );
#endif  // ifdef EXTRASETELEMS

#ifdef EXTRASETS
    MPD( AddSolverOption_MergeDuplicates("prob:extrasets EXTRASETS",
      ...
      "\n\nDefault: 0",
      EXTRASETS, INT_MIN, INT_MAX) );
#endif  // ifdef EXTRASETS

#ifdef FEASIBILITYJUMP
    MPD( AddSolverOption_MergeDuplicates("heur:feasibilityjump FEASIBILITYJUMP",
      ...
      FEASIBILITYJUMP, INT_MIN, INT_MAX) );
#endif  // ifdef FEASIBILITYJUMP

#ifdef FEASIBILITYPUMP
    MPD( AddSolverOption_MergeDuplicates("heur:feasibilitypump FEASIBILITYPUMP",
      ...
      FEASIBILITYPUMP, INT_MIN, INT_MAX) );
#endif  // ifdef FEASIBILITYPUMP

#ifdef FEASTOL
    MPD( AddSolverOption_MergeDuplicates("tol:feastol FEASTOL",
      ...
      "\n\nDefault: 1.0E-06",
      FEASTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef FEASTOL

#ifdef FEASTOLPERTURB
    MPD( AddSolverOption_MergeDuplicates("sim:feastolperturb FEASTOLPERTURB",
      ...
      "\n\nDefault: 1.0E-06",
      FEASTOLPERTURB, -DBL_MAX, DBL_MAX) );
#endif  // ifdef FEASTOLPERTURB

#ifdef FEASTOLTARGET
    MPD( AddSolverOption_MergeDuplicates("sol:feastoltarget FEASTOLTARGET",
      "This specifies the target feasibility tolerance for the solution refiner."
      "\n\nDefault: 0 — use the value specified by FEASTOL.",
      FEASTOLTARGET, -DBL_MAX, DBL_MAX) );
#endif  // ifdef FEASTOLTARGET

#ifdef FORCEOUTPUT
    MPD( AddSolverOption_MergeDuplicates("tech:forceoutput FORCEOUTPUT",
      ...
      FORCEOUTPUT, INT_MIN, INT_MAX) );
#endif  // ifdef FORCEOUTPUT

#ifdef FORCEPARALLELDUAL
    MPD( AddSolverOption_MergeDuplicates("lp:forceparalleldual FORCEPARALLELDUAL",
      ...
      FORCEPARALLELDUAL, INT_MIN, INT_MAX) );
#endif  // ifdef FORCEPARALLELDUAL

#ifdef GENCONSABSTRANSFORMATION
    MPD( AddSolverOption_MergeDuplicates("pre:genconsabstransformation GENCONSABSTRANSFORMATION",
      ...
      GENCONSABSTRANSFORMATION, INT_MIN, INT_MAX) );
#endif  // ifdef GENCONSABSTRANSFORMATION

#ifdef GENCONSDUALREDUCTIONS
    MPD( AddSolverOption_MergeDuplicates("pre:genconsdualreductions GENCONSDUALREDUCTIONS",
      ...
      GENCONSDUALREDUCTIONS, INT_MIN, INT_MAX) );
#endif  // ifdef GENCONSDUALREDUCTIONS

#ifdef GLOBALBOUNDINGBOX
    MPD( AddSolverOption_MergeDuplicates("global:boundingbox GLOBALBOUNDINGBOX",
      ...
      GLOBALBOUNDINGBOX, -DBL_MAX, DBL_MAX) );
#endif  // ifdef GLOBALBOUNDINGBOX

#ifdef GLOBALLSHEURSTRATEGY
    MPD( AddSolverOption_MergeDuplicates("global:lsheurstrategy GLOBALLSHEURSTRATEGY",
      ...
      GLOBALLSHEURSTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef GLOBALLSHEURSTRATEGY

#ifdef GLOBALNLPCUTS
    MPD( AddSolverOption_MergeDuplicates("global:nlpcuts GLOBALNLPCUTS",
      ...
      "\n\nDefault: -1 — determined automatically.",
      GLOBALNLPCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef GLOBALNLPCUTS

#ifdef GLOBALNUMINITNLPCUTS
    MPD( AddSolverOption_MergeDuplicates("global:numinitnlpcuts GLOBALNUMINITNLPCUTS",
      ...
      "\n\nDefault: -1 — determined automatically.",
      GLOBALNUMINITNLPCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef GLOBALNUMINITNLPCUTS

#ifdef GLOBALPRESOLVEOBBT
    MPD( AddSolverOption_MergeDuplicates("global:presolveobbt GLOBALPRESOLVEOBBT",
      ...
      GLOBALPRESOLVEOBBT, INT_MIN, INT_MAX) );
#endif  // ifdef GLOBALPRESOLVEOBBT

#ifdef GLOBALSPATIALBRANCHCUTTINGEFFORT
    MPD( AddSolverOption_MergeDuplicates("global:spatialbranchcuttingeffort GLOBALSPATIALBRANCHCUTTINGEFFORT",
      ...
      GLOBALSPATIALBRANCHCUTTINGEFFORT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef GLOBALSPATIALBRANCHCUTTINGEFFORT

#ifdef GLOBALSPATIALBRANCHIFPREFERORIG
    MPD( AddSolverOption_MergeDuplicates("global:spatialbranchifpreferorig GLOBALSPATIALBRANCHIFPREFERORIG",
      ...
      GLOBALSPATIALBRANCHIFPREFERORIG, INT_MIN, INT_MAX) );
#endif  // ifdef GLOBALSPATIALBRANCHIFPREFERORIG

#ifdef GLOBALSPATIALBRANCHPROPAGATIONEFFORT
    MPD( AddSolverOption_MergeDuplicates("global:spatialbranchpropagationeffort GLOBALSPATIALBRANCHPROPAGATIONEFFORT",
      ...
      GLOBALSPATIALBRANCHPROPAGATIONEFFORT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef GLOBALSPATIALBRANCHPROPAGATIONEFFORT

#ifdef GLOBALTREENLPCUTS
    MPD( AddSolverOption_MergeDuplicates("global:treenlpcuts GLOBALTREENLPCUTS",
      ...
      "\n\nDefault: -1 — determined automatically.",
      GLOBALTREENLPCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef GLOBALTREENLPCUTS

#ifdef GOMCUTS
    MPD( AddSolverOption_MergeDuplicates("pre:gomcuts GOMCUTS",
      "Branch and Bound: The number of rounds of Gomory or lift-and-project cuts at the root node."
      "\n\nDefault: -1 — determined automatically.",
      GOMCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef GOMCUTS

#ifdef GPUPLATFORM
    MPD( AddSolverOption_MergeDuplicates("sys:gpuplatform GPUPLATFORM",
      ...
      GPUPLATFORM, INT_MIN, INT_MAX) );
#endif  // ifdef GPUPLATFORM

#ifdef HEURBEFORELP
    MPD( AddSolverOption_MergeDuplicates("heur:beforelp HEURBEFORELP",
      ...
      "\n- (0)  Disabled."
      "\n- (1)  Enabled.",
      HEURBEFORELP, INT_MIN, INT_MAX) );
#endif  // ifdef HEURBEFORELP

#ifdef HEURDEPTH
    MPD( AddSolverOption_MergeDuplicates("heur:depth HEURDEPTH",
      ...
      "\n\nDefault: -1",
      HEURDEPTH, INT_MIN, INT_MAX) );
#endif  // ifdef HEURDEPTH

#ifdef HEURDIVEITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("heur:diveiterlimit HEURDIVEITERLIMIT",
      ...
      HEURDIVEITERLIMIT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef HEURDIVEITERLIMIT

#ifdef HEURDIVERANDOMIZE
    MPD( AddSolverOption_MergeDuplicates("heur:diverandomize HEURDIVERANDOMIZE",
      ...
      HEURDIVERANDOMIZE, -DBL_MAX, DBL_MAX) );
#endif  // ifdef HEURDIVERANDOMIZE

#ifdef HEURDIVESOFTROUNDING
    MPD( AddSolverOption_MergeDuplicates("heur:divesoftrounding HEURDIVESOFTROUNDING",
      ...
      HEURDIVESOFTROUNDING, INT_MIN, INT_MAX) );
#endif  // ifdef HEURDIVESOFTROUNDING

#ifdef HEURDIVESPEEDUP
    MPD( AddSolverOption_MergeDuplicates("heur:divespeedup HEURDIVESPEEDUP",
      ...
      HEURDIVESPEEDUP, INT_MIN, INT_MAX) );
#endif  // ifdef HEURDIVESPEEDUP

#ifdef HEURDIVESTRATEGY
    MPD( AddSolverOption_MergeDuplicates("heur:divestrategy HEURDIVESTRATEGY",
      ...
      HEURDIVESTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef HEURDIVESTRATEGY

#ifdef HEUREMPHASIS
    MPD( AddSolverOption_MergeDuplicates("heur:emphasis HEUREMPHASIS",
      ...
      HEUREMPHASIS, INT_MIN, INT_MAX) );
#endif  // ifdef HEUREMPHASIS

#ifdef HEURFORCESPECIALOBJ
    MPD( AddSolverOption_MergeDuplicates("heur:forcespecialobj HEURFORCESPECIALOBJ",
      ...
      HEURFORCESPECIALOBJ, INT_MIN, INT_MAX) );
#endif  // ifdef HEURFORCESPECIALOBJ

#ifdef HEURFREQ
    MPD( AddSolverOption_MergeDuplicates("heur:freq HEURFREQ",
      ...
      "\n\nDefault: -1",
      HEURFREQ, INT_MIN, INT_MAX) );
#endif  // ifdef HEURFREQ

#ifdef HEURMAXSOL
    MPD( AddSolverOption_MergeDuplicates("heur:maxsol HEURMAXSOL",
      ...
      "\n\nDefault: -1",
      HEURMAXSOL, INT_MIN, INT_MAX) );
#endif  // ifdef HEURMAXSOL

#ifdef HEURNODES
    MPD( AddSolverOption_MergeDuplicates("heur:nodes HEURNODES",
      ...
      "\n\nDefault: -1",
      HEURNODES, INT_MIN, INT_MAX) );
#endif  // ifdef HEURNODES

#ifdef HEURSEARCHBACKGROUNDSELECT
    MPD( AddSolverOption_MergeDuplicates("heur:searchbackgroundselect HEURSEARCHBACKGROUNDSELECT",
      ...
      HEURSEARCHBACKGROUNDSELECT, INT_MIN, INT_MAX) );
#endif  // ifdef HEURSEARCHBACKGROUNDSELECT

#ifdef HEURSEARCHCOPYCONTROLS
    MPD( AddSolverOption_MergeDuplicates("heur:searchcopycontrols HEURSEARCHCOPYCONTROLS",
      ...
      HEURSEARCHCOPYCONTROLS, INT_MIN, INT_MAX) );
#endif  // ifdef HEURSEARCHCOPYCONTROLS

#ifdef HEURSEARCHEFFORT
    MPD( AddSolverOption_MergeDuplicates("heur:searcheffort HEURSEARCHEFFORT",
      "Adjusts the overall level of the local search heuristics."
      "\n\nDefault: 1.0",
      HEURSEARCHEFFORT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef HEURSEARCHEFFORT

#ifdef HEURSEARCHFREQ
    MPD( AddSolverOption_MergeDuplicates("heur:searchfreq HEURSEARCHFREQ",
      ...
      HEURSEARCHFREQ, INT_MIN, INT_MAX) );
#endif  // ifdef HEURSEARCHFREQ

#ifdef HEURSEARCHROOTCUTFREQ
    MPD( AddSolverOption_MergeDuplicates("heur:searchrootcutfreq HEURSEARCHROOTCUTFREQ",
      ...
      HEURSEARCHROOTCUTFREQ, INT_MIN, INT_MAX) );
#endif  // ifdef HEURSEARCHROOTCUTFREQ

#ifdef HEURSEARCHROOTSELECT
    MPD( AddSolverOption_MergeDuplicates("heur:searchrootselect HEURSEARCHROOTSELECT",
      ...
      HEURSEARCHROOTSELECT, INT_MIN, INT_MAX) );
#endif  // ifdef HEURSEARCHROOTSELECT

#ifdef HEURSEARCHTREESELECT
    MPD( AddSolverOption_MergeDuplicates("heur:searchtreeselect HEURSEARCHTREESELECT",
      ...
      "\n- (5)  Local search without an objective function. Called seldom and only when no feasible solution is available."
      "\n- (6)  Local search with an auxiliary objective function. Called seldom and only when no feasible solution is available.",
      HEURSEARCHTREESELECT, INT_MIN, INT_MAX) );
#endif  // ifdef HEURSEARCHTREESELECT

#ifdef HEURSHIFTPROP
    MPD( AddSolverOption_MergeDuplicates("heur:shiftprop HEURSHIFTPROP",
      ...
      HEURSHIFTPROP, INT_MIN, INT_MAX) );
#endif  // ifdef HEURSHIFTPROP

#ifdef HEURTHREADS
    MPD( AddSolverOption_MergeDuplicates("heur:threads HEURTHREADS",
      ...
      HEURTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef HEURTHREADS

#ifdef HISTORYCOSTS
    MPD( AddSolverOption_MergeDuplicates("mip:historycosts HISTORYCOSTS",
      ...
      HISTORYCOSTS, INT_MIN, INT_MAX) );
#endif  // ifdef HISTORYCOSTS

#ifdef IFCHECKCONVEXITY
    MPD( AddSolverOption_MergeDuplicates("pre:ifcheckconvexity IFCHECKCONVEXITY",
      ...
      IFCHECKCONVEXITY, INT_MIN, INT_MAX) );
#endif  // ifdef IFCHECKCONVEXITY

#ifdef IISLOG
    MPD( AddSolverOption_MergeDuplicates("inf:iislog IISLOG",
      ...
      IISLOG, INT_MIN, INT_MAX) );
#endif  // ifdef IISLOG

#ifdef IISOPS
    MPD( AddSolverOption_MergeDuplicates("inf:iisops IISOPS",
      ...
      IISOPS, INT_MIN, INT_MAX) );
#endif  // ifdef IISOPS

#ifdef INDLINBIGM
    MPD( AddSolverOption_MergeDuplicates("pre:indlinbigm INDLINBIGM",
      ...
      "\n\nDefault: 1.0E+05",
      INDLINBIGM, -DBL_MAX, DBL_MAX) );
#endif  // ifdef INDLINBIGM

#ifdef INDPRELINBIGM
    MPD( AddSolverOption_MergeDuplicates("pre:indprelinbigm INDPRELINBIGM",
      ...
      "\n\nDefault: 100.0",
      INDPRELINBIGM, -DBL_MAX, DBL_MAX) );
#endif  // ifdef INDPRELINBIGM

#ifdef INPUTTOL
    MPD( AddSolverOption_MergeDuplicates("prob:inputtol INPUTTOL",
      ...
      "\n\nDefault: 0.0",
      INPUTTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef INPUTTOL

#ifdef INVERTFREQ
    MPD( AddSolverOption_MergeDuplicates("sim:invertfreq INVERTFREQ",
      ...
      INVERTFREQ, INT_MIN, INT_MAX) );
#endif  // ifdef INVERTFREQ

#ifdef INVERTMIN
    MPD( AddSolverOption_MergeDuplicates("sim:invertmin INVERTMIN",
      ...
      "\n\nDefault: 3",
      INVERTMIN, INT_MIN, INT_MAX) );
#endif  // ifdef INVERTMIN

#ifdef IOTIMEOUT
    MPD( AddSolverOption_MergeDuplicates("tech:iotimeout IOTIMEOUT",
      "The maximum number of seconds to wait for an I/O operation before it is cancelled."
      "\n\nDefault: 30",
      IOTIMEOUT, INT_MIN, INT_MAX) );
#endif  // ifdef IOTIMEOUT

#ifdef KEEPBASIS
    MPD( AddSolverOption_MergeDuplicates("lp:keepbasis KEEPBASIS",
      ...
      KEEPBASIS, INT_MIN, INT_MAX) );
#endif  // ifdef KEEPBASIS

#ifdef KEEPNROWS
    MPD( AddSolverOption_MergeDuplicates("prob:keepnrows KEEPNROWS",
      ...
      "\n- (1)  Keep N type rows.",
      KEEPNROWS, INT_MIN, INT_MAX) );
#endif  // ifdef KEEPNROWS

#ifdef L1CACHE
    MPD( AddSolverOption_MergeDuplicates("bar:l1cache L1CACHE",
      ...
      "\n\nDefault: Hardware/platform dependent.",
      L1CACHE, INT_MIN, INT_MAX) );
#endif  // ifdef L1CACHE

#ifdef LNPBEST
    MPD( AddSolverOption_MergeDuplicates("pre:lnpbest LNPBEST",
      ...
      "\n\nDefault: 50",
      LNPBEST, INT_MIN, INT_MAX) );
#endif  // ifdef LNPBEST

#ifdef LNPITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("cut:lnpiterlimit LNPITERLIMIT",
      "Number of iterations to perform in improving each lift-and-project cut."
      "\n\nDefault: -1 — determined automatically.",
      LNPITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef LNPITERLIMIT

#ifdef LOCALCHOICE
    MPD( AddSolverOption_MergeDuplicates("mip:localchoice LOCALCHOICE",
      ...
      LOCALCHOICE, INT_MIN, INT_MAX) );
#endif  // ifdef LOCALCHOICE

#ifdef LPFLAGS
    MPD( AddSolverOption_MergeDuplicates("pre:lpflags LPFLAGS",
      ...
      LPFLAGS, INT_MIN, INT_MAX) );
#endif  // ifdef LPFLAGS

#ifdef LPFOLDING
    MPD( AddSolverOption_MergeDuplicates("lp:folding LPFOLDING",
      ...
      LPFOLDING, INT_MIN, INT_MAX) );
#endif  // ifdef LPFOLDING

#ifdef LPITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("lp:iterlimit LPITERLIMIT",
      ...
      "\n\nDefault: 2147483647",
      LPITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef LPITERLIMIT

#ifdef LPLOG
    MPD( AddSolverOption_MergeDuplicates("lp:log LPLOG",
      ...
      LPLOG, INT_MIN, INT_MAX) );
#endif  // ifdef LPLOG

#ifdef LPLOGDELAY
    MPD( AddSolverOption_MergeDuplicates("lp:logdelay LPLOGDELAY",
      "Time interval between two LP log lines. "
      "\n\nDefault: 1.0",
      LPLOGDELAY, -DBL_MAX, DBL_MAX) );
#endif  // ifdef LPLOGDELAY

#ifdef LPLOGSTYLE
    MPD( AddSolverOption_MergeDuplicates("lp:logstyle LPLOGSTYLE",
      ...
      LPLOGSTYLE, INT_MIN, INT_MAX) );
#endif  // ifdef LPLOGSTYLE

#ifdef LPREFINEITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("sol:lprefineiterlimit LPREFINEITERLIMIT",
      ...
      "\n\nDefault: -1 — determined automatically.",
      LPREFINEITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef LPREFINEITERLIMIT

#ifdef MARKOWITZTOL
    MPD( AddSolverOption_MergeDuplicates("lp:markowitztol MARKOWITZTOL",
      "The Markowitz tolerance used for the factorization of the basis matrix."
      "\n\nDefault: 0.01",
      MARKOWITZTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MARKOWITZTOL

#ifdef MATRIXTOL
    MPD( AddSolverOption_MergeDuplicates("tol:matrixtol MATRIXTOL",
      ...
      "\n\nDefault: 1.0E-09",
      MATRIXTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MATRIXTOL

#ifdef MAXCHECKSONMAXCUTTIME
    MPD( AddSolverOption_MergeDuplicates("lim:maxchecksonmaxcuttime MAXCHECKSONMAXCUTTIME",
      ...
      MAXCHECKSONMAXCUTTIME, INT_MIN, INT_MAX) );
#endif  // ifdef MAXCHECKSONMAXCUTTIME

#ifdef MAXCHECKSONMAXTIME
    MPD( AddSolverOption_MergeDuplicates("lim:maxchecksonmaxtime MAXCHECKSONMAXTIME",
      ...
      MAXCHECKSONMAXTIME, INT_MIN, INT_MAX) );
#endif  // ifdef MAXCHECKSONMAXTIME

#ifdef MAXCUTTIME
    MPD( AddSolverOption_MergeDuplicates("lim:maxcuttime MAXCUTTIME",
      ...
      MAXCUTTIME, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MAXCUTTIME

#ifdef MAXIIS
    MPD( AddSolverOption_MergeDuplicates("inf:maxiis MAXIIS",
      ...
      MAXIIS, INT_MIN, INT_MAX) );
#endif  // ifdef MAXIIS

#ifdef MAXIMPLIEDBOUND
    MPD( AddSolverOption_MergeDuplicates("pre:maximpliedbound MAXIMPLIEDBOUND",
      ...
      "\n\nDefault: 1.0E+08",
      MAXIMPLIEDBOUND, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MAXIMPLIEDBOUND

#ifdef MAXLOCALBACKTRACK
    MPD( AddSolverOption_MergeDuplicates("mip:maxlocalbacktrack MAXLOCALBACKTRACK",
      ...
      MAXLOCALBACKTRACK, INT_MIN, INT_MAX) );
#endif  // ifdef MAXLOCALBACKTRACK

#ifdef MAXMCOEFFBUFFERELEMS
    MPD( AddSolverOption_MergeDuplicates("prob:maxmcoeffbufferelems MAXMCOEFFBUFFERELEMS",
      ...
      "\n\nDefault: 2147483647",
      MAXMCOEFFBUFFERELEMS, INT_MIN, INT_MAX) );
#endif  // ifdef MAXMCOEFFBUFFERELEMS

#ifdef MAXMEMORYHARD
    MPD( AddSolverOption_MergeDuplicates("tech:maxmemoryhard MAXMEMORYHARD",
      ...
      "\n\nDefault: 0 (no limit)",
      MAXMEMORYHARD, INT_MIN, INT_MAX) );
#endif  // ifdef MAXMEMORYHARD

#ifdef MAXMEMORYSOFT
    MPD( AddSolverOption_MergeDuplicates("tech:maxmemorysoft MAXMEMORYSOFT",
      ...
      "\n\nDefault: 0 (no limit)",
      MAXMEMORYSOFT, INT_MIN, INT_MAX) );
#endif  // ifdef MAXMEMORYSOFT

#ifdef MAXMIPSOL
    MPD( AddSolverOption_MergeDuplicates("lim:maxmipsol MAXMIPSOL",
      ...
      "\n\nDefault: 0",
      MAXMIPSOL, INT_MIN, INT_MAX) );
#endif  // ifdef MAXMIPSOL

#ifdef MAXMIPTASKS
    MPD( AddSolverOption_MergeDuplicates("tech:maxmiptasks MAXMIPTASKS",
      ...
      "\n- (>0)  Fixed task limit.",
      MAXMIPTASKS, INT_MIN, INT_MAX) );
#endif  // ifdef MAXMIPTASKS

#ifdef MAXNODE
    MPD( AddSolverOption_MergeDuplicates("mip:maxnode MAXNODE",
      "Branch and Bound: The maximum number of nodes that will be explored."
      "\n\nDefault: 2147483647",
      MAXNODE, INT_MIN, INT_MAX) );
#endif  // ifdef MAXNODE

#ifdef MAXPAGELINES
    MPD( AddSolverOption_MergeDuplicates("log:maxpagelines MAXPAGELINES",
      "Number of lines between page breaks in printable output."
      "\n\nDefault: 23",
      MAXPAGELINES, INT_MIN, INT_MAX) );
#endif  // ifdef MAXPAGELINES

#ifdef MAXSCALEFACTOR
    MPD( AddSolverOption_MergeDuplicates("pre:maxscalefactor MAXSCALEFACTOR",
      ...
      MAXSCALEFACTOR, INT_MIN, INT_MAX) );
#endif  // ifdef MAXSCALEFACTOR

#ifdef MAXSTALLTIME
    MPD( AddSolverOption_MergeDuplicates("lim:maxstalltime MAXSTALLTIME",
      ...
      MAXSTALLTIME, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MAXSTALLTIME

#ifdef MAXTIME
    MPD( AddSolverOption_MergeDuplicates("lim:maxtime MAXTIME",
      ...
      MAXTIME, INT_MIN, INT_MAX) );
#endif  // ifdef MAXTIME

#ifdef MAXTREEFILESIZE
    MPD( AddSolverOption_MergeDuplicates("tech:maxtreefilesize MAXTREEFILESIZE",
      ...
      "\n\nDefault: 0",
      MAXTREEFILESIZE, INT_MIN, INT_MAX) );
#endif  // ifdef MAXTREEFILESIZE

#ifdef MCFCUTSTRATEGY
    MPD( AddSolverOption_MergeDuplicates("cut:mcfcutstrategy MCFCUTSTRATEGY",
      ...
      MCFCUTSTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef MCFCUTSTRATEGY

#ifdef MIPABSCUTOFF
    MPD( AddSolverOption_MergeDuplicates("lim:mipabscutoff MIPABSCUTOFF",
      ...
      MIPABSCUTOFF, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPABSCUTOFF

#ifdef MIPABSGAPNOTIFY
    MPD( AddSolverOption_MergeDuplicates("tech:mipabsgapnotify MIPABSGAPNOTIFY",
      ...
      "\n\nDefault: -1.0",
      MIPABSGAPNOTIFY, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPABSGAPNOTIFY

#ifdef MIPABSGAPNOTIFYBOUND
    MPD( AddSolverOption_MergeDuplicates("tech:mipabsgapnotifybound MIPABSGAPNOTIFYBOUND",
      ...
      MIPABSGAPNOTIFYBOUND, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPABSGAPNOTIFYBOUND

#ifdef MIPABSGAPNOTIFYOBJ
    MPD( AddSolverOption_MergeDuplicates("tech:mipabsgapnotifyobj MIPABSGAPNOTIFYOBJ",
      ...
      "\n\nDefault: -1.0E+20 (for minimization problems); 1.0E+20 (for maximization problems)",
      MIPABSGAPNOTIFYOBJ, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPABSGAPNOTIFYOBJ

#ifdef MIPABSSTOP
    MPD( AddSolverOption_MergeDuplicates("lim:mipabsstop MIPABSSTOP",
      ...
      "\n\nDefault: 0.0",
      MIPABSSTOP, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPABSSTOP

#ifdef MIPADDCUTOFF
    MPD( AddSolverOption_MergeDuplicates("mip:addcutoff MIPADDCUTOFF",
      ...
      "\n\nDefault: -1.0E-05",
      MIPADDCUTOFF, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPADDCUTOFF

#ifdef MIPCOMPONENTS
    MPD( AddSolverOption_MergeDuplicates("mip:components MIPCOMPONENTS",
      ...
      MIPCOMPONENTS, INT_MIN, INT_MAX) );
#endif  // ifdef MIPCOMPONENTS

#ifdef MIPCONCURRENTNODES
    MPD( AddSolverOption_MergeDuplicates("mip:concurrentnodes MIPCONCURRENTNODES",
      ...
      MIPCONCURRENTNODES, INT_MIN, INT_MAX) );
#endif  // ifdef MIPCONCURRENTNODES

#ifdef MIPCONCURRENTSOLVES
    MPD( AddSolverOption_MergeDuplicates("mip:concurrentsolves MIPCONCURRENTSOLVES",
      ...
      MIPCONCURRENTSOLVES, INT_MIN, INT_MAX) );
#endif  // ifdef MIPCONCURRENTSOLVES

#ifdef MIPDUALREDUCTIONS
    MPD( AddSolverOption_MergeDuplicates("pre:mipdualreductions MIPDUALREDUCTIONS",
      ...
      MIPDUALREDUCTIONS, INT_MIN, INT_MAX) );
#endif  // ifdef MIPDUALREDUCTIONS

#ifdef MIPFRACREDUCE
    MPD( AddSolverOption_MergeDuplicates("pre:mipfracreduce MIPFRACREDUCE",
      ...
      MIPFRACREDUCE, INT_MIN, INT_MAX) );
#endif  // ifdef MIPFRACREDUCE

#ifdef MIPKAPPAFREQ
    MPD( AddSolverOption_MergeDuplicates("mip:kappafreq MIPKAPPAFREQ",
      ...
      MIPKAPPAFREQ, INT_MIN, INT_MAX) );
#endif  // ifdef MIPKAPPAFREQ

#ifdef MIPLOG
    MPD( AddSolverOption_MergeDuplicates("log:miplog MIPLOG",
      ...
      MIPLOG, INT_MIN, INT_MAX) );
#endif  // ifdef MIPLOG

#ifdef MIPPRESOLVE
    MPD( AddSolverOption_MergeDuplicates("pre:mippresolve MIPPRESOLVE",
      ...
      MIPPRESOLVE, INT_MIN, INT_MAX) );
#endif  // ifdef MIPPRESOLVE

#ifdef MIPRAMPUP
    MPD( AddSolverOption_MergeDuplicates("mip:rampup MIPRAMPUP",
      ...
      MIPRAMPUP, INT_MIN, INT_MAX) );
#endif  // ifdef MIPRAMPUP

#ifdef MIPREFINEITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("sol:miprefineiterlimit MIPREFINEITERLIMIT",
      ...
      "\n\nDefault: -1 — determined automatically.",
      MIPREFINEITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef MIPREFINEITERLIMIT

#ifdef MIPRELCUTOFF
    MPD( AddSolverOption_MergeDuplicates("lim:miprelcutoff MIPRELCUTOFF",
      ...
      "\n\nDefault: 1.0E-04",
      MIPRELCUTOFF, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPRELCUTOFF

#ifdef MIPRELGAPNOTIFY
    MPD( AddSolverOption_MergeDuplicates("tech:miprelgapnotify MIPRELGAPNOTIFY",
      ...
      "\n\nDefault: -1.0",
      MIPRELGAPNOTIFY, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPRELGAPNOTIFY

#ifdef MIPRELSTOP
    MPD( AddSolverOption_MergeDuplicates("lim:miprelstop MIPRELSTOP",
      ...
      "\n\nDefault: 0.0001",
      MIPRELSTOP, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPRELSTOP

#ifdef MIPRESTART
    MPD( AddSolverOption_MergeDuplicates("mip:restart MIPRESTART",
      ...
      MIPRESTART, INT_MIN, INT_MAX) );
#endif  // ifdef MIPRESTART

#ifdef MIPRESTARTFACTOR
    MPD( AddSolverOption_MergeDuplicates("mip:restartfactor MIPRESTARTFACTOR",
      ...
      "\n\nDefault: 1.0",
      MIPRESTARTFACTOR, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPRESTARTFACTOR

#ifdef MIPRESTARTGAPTHRESHOLD
    MPD( AddSolverOption_MergeDuplicates("mip:restartgapthreshold MIPRESTARTGAPTHRESHOLD",
      ...
      "\n\nDefault: 0.02",
      MIPRESTARTGAPTHRESHOLD, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPRESTARTGAPTHRESHOLD

#ifdef MIPTERMINATIONMETHOD
    MPD( AddSolverOption_MergeDuplicates("mip:terminationmethod MIPTERMINATIONMETHOD",
      ...
      MIPTERMINATIONMETHOD, INT_MIN, INT_MAX) );
#endif  // ifdef MIPTERMINATIONMETHOD

#ifdef MIPTHREADS
    MPD( AddSolverOption_MergeDuplicates("mip:threads MIPTHREADS",
      ...
      "\n\nDefault: -1 (determined by the THREADS control)",
      MIPTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef MIPTHREADS

#ifdef MIPTOL
    MPD( AddSolverOption_MergeDuplicates("tol:miptol MIPTOL",
      "Branch and Bound: This is the tolerance within which a decision variable's value is considered to be integral."
      "\n\nDefault: 5.0E-06",
      MIPTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPTOL

#ifdef MIPTOLTARGET
    MPD( AddSolverOption_MergeDuplicates("sol:miptoltarget MIPTOLTARGET",
      ...
      "\n\nDefault: 0.0",
      MIPTOLTARGET, -DBL_MAX, DBL_MAX) );
#endif  // ifdef MIPTOLTARGET

#ifdef MIQCPALG
    MPD( AddSolverOption_MergeDuplicates("qp:miqcpalg MIQCPALG",
      ...
      MIQCPALG, INT_MIN, INT_MAX) );
#endif  // ifdef MIQCPALG

#ifdef MPS18COMPATIBLE
    MPD( AddSolverOption_MergeDuplicates("tech:mps18compatible MPS18COMPATIBLE",
      ...
      MPS18COMPATIBLE, INT_MIN, INT_MAX) );
#endif  // ifdef MPS18COMPATIBLE

#ifdef MPSBOUNDNAME
    MPD( AddSolverOption_MergeDuplicates("tech:mpsboundname MPSBOUNDNAME",
      ...
      "\n\nDefault: 64 blanks",
      MPSBOUNDNAME) );
#endif  // ifdef MPSBOUNDNAME

#ifdef MPSECHO
    MPD( AddSolverOption_MergeDuplicates("tech:mpsecho MPSECHO",
      ...
      MPSECHO, INT_MIN, INT_MAX) );
#endif  // ifdef MPSECHO

#ifdef MPSFORMAT
    MPD( AddSolverOption_MergeDuplicates("tech:mpsformat MPSFORMAT",
      ...
      MPSFORMAT, INT_MIN, INT_MAX) );
#endif  // ifdef MPSFORMAT

#ifdef MPSOBJNAME
    MPD( AddSolverOption_MergeDuplicates("tech:mpsobjname MPSOBJNAME",
      ...
      "\n\nDefault: 64 blanks",
      MPSOBJNAME) );
#endif  // ifdef MPSOBJNAME

#ifdef MPSRANGENAME
    MPD( AddSolverOption_MergeDuplicates("tech:mpsrangename MPSRANGENAME",
      ...
      "\n\nDefault: 64 blanks",
      MPSRANGENAME) );
#endif  // ifdef MPSRANGENAME

#ifdef MPSRHSNAME
    MPD( AddSolverOption_MergeDuplicates("tech:mpsrhsname MPSRHSNAME",
      ...
      "\n\nDefault: 64 blanks",
      MPSRHSNAME) );
#endif  // ifdef MPSRHSNAME

#ifdef MULTIOBJLOG
    MPD( AddSolverOption_MergeDuplicates("obj:multi:multiobjlog MULTIOBJLOG",
      ...
      MULTIOBJLOG, INT_MIN, INT_MAX) );
#endif  // ifdef MULTIOBJLOG

#ifdef MULTIOBJOPS
    MPD( AddSolverOption_MergeDuplicates("obj:multi:multiobjops MULTIOBJOPS",
      ...
      MULTIOBJOPS, INT_MIN, INT_MAX) );
#endif  // ifdef MULTIOBJOPS

#ifdef MUTEXCALLBACKS
    MPD( AddSolverOption_MergeDuplicates("mip:mutexcallbacks MUTEXCALLBACKS",
      ...
      MUTEXCALLBACKS, INT_MIN, INT_MAX) );
#endif  // ifdef MUTEXCALLBACKS

#ifdef NETSTALLLIMIT
    MPD( AddSolverOption_MergeDuplicates("sim:netstalllimit NETSTALLLIMIT",
      ...
      NETSTALLLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef NETSTALLLIMIT

#ifdef NODEPROBINGEFFORT
    MPD( AddSolverOption_MergeDuplicates("pre:nodeprobingeffort NODEPROBINGEFFORT",
      "Adjusts the overall level of node probing."
      "\n\nDefault: 1.0",
      NODEPROBINGEFFORT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef NODEPROBINGEFFORT

#ifdef NODESELECTION
    MPD( AddSolverOption_MergeDuplicates("mip:nodeselection NODESELECTION",
      ...
      NODESELECTION, INT_MIN, INT_MAX) );
#endif  // ifdef NODESELECTION

#ifdef NUMERICALEMPHASIS
    MPD( AddSolverOption_MergeDuplicates("num:ericalemphasis NUMERICALEMPHASIS",
      ...
      NUMERICALEMPHASIS, INT_MIN, INT_MAX) );
#endif  // ifdef NUMERICALEMPHASIS

#ifdef OBJSCALEFACTOR
    MPD( AddSolverOption_MergeDuplicates("num:objscalefactor OBJSCALEFACTOR",
      ...
      "\n\nDefault: 0",
      OBJSCALEFACTOR, -DBL_MAX, DBL_MAX) );
#endif  // ifdef OBJSCALEFACTOR

#ifdef OPTIMALITYTOL
    MPD( AddSolverOption_MergeDuplicates("tol:optimalitytol OPTIMALITYTOL",
      ...
      "\n\nDefault: 1.0E-06",
      OPTIMALITYTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef OPTIMALITYTOL

#ifdef OPTIMALITYTOLTARGET
    MPD( AddSolverOption_MergeDuplicates("sol:optimalitytoltarget OPTIMALITYTOLTARGET",
      ...
      OPTIMALITYTOLTARGET, -DBL_MAX, DBL_MAX) );
#endif  // ifdef OPTIMALITYTOLTARGET

#ifdef OUTPUTCONTROLS
    MPD( AddSolverOption_MergeDuplicates("log:outputcontrols OUTPUTCONTROLS",
      ...
      "\n- (1)  Print controls.",
      OUTPUTCONTROLS, INT_MIN, INT_MAX) );
#endif  // ifdef OUTPUTCONTROLS

#ifdef OUTPUTLOG
    MPD( AddSolverOption_MergeDuplicates("log:outputlog OUTPUTLOG",
      ...
      OUTPUTLOG, INT_MIN, INT_MAX) );
#endif  // ifdef OUTPUTLOG

#ifdef OUTPUTMASK
    MPD( AddSolverOption_MergeDuplicates("tech:outputmask OUTPUTMASK",
      ...
      "\n\nDefault: 64 '?'s",
      OUTPUTMASK) );
#endif  // ifdef OUTPUTMASK

#ifdef OUTPUTTOL
    MPD( AddSolverOption_MergeDuplicates("tech:outputtol OUTPUTTOL",
      "Zero tolerance on print values."
      "\n\nDefault: 1.0E-05",
      OUTPUTTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef OUTPUTTOL

#ifdef PENALTY
    MPD( AddSolverOption_MergeDuplicates("pre:penalty PENALTY",
      ...
      "\n\nDefault: Dependent on the matrix characteristics.",
      PENALTY, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PENALTY

#ifdef PIVOTTOL
    MPD( AddSolverOption_MergeDuplicates("sim:pivottol PIVOTTOL",
      ...
      "\n\nDefault: 1.0E-09",
      PIVOTTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PIVOTTOL

#ifdef PPFACTOR
    MPD( AddSolverOption_MergeDuplicates("sim:ppfactor PPFACTOR",
      "The partial pricing candidate list sizing parameter."
      "\n\nDefault: 1.0",
      PPFACTOR, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PPFACTOR

#ifdef PREANALYTICCENTER
    MPD( AddSolverOption_MergeDuplicates("bar:preanalyticcenter PREANALYTICCENTER",
      ...
      PREANALYTICCENTER, INT_MIN, INT_MAX) );
#endif  // ifdef PREANALYTICCENTER

#ifdef PREBASISRED
    MPD( AddSolverOption_MergeDuplicates("pre:basisred PREBASISRED",
      ...
      PREBASISRED, INT_MIN, INT_MAX) );
#endif  // ifdef PREBASISRED

#ifdef PREBNDREDCONE
    MPD( AddSolverOption_MergeDuplicates("pre:bndredcone PREBNDREDCONE",
      ...
      PREBNDREDCONE, INT_MIN, INT_MAX) );
#endif  // ifdef PREBNDREDCONE

#ifdef PREBNDREDQUAD
    MPD( AddSolverOption_MergeDuplicates("pre:bndredquad PREBNDREDQUAD",
      ...
      PREBNDREDQUAD, INT_MIN, INT_MAX) );
#endif  // ifdef PREBNDREDQUAD

#ifdef PRECLIQUESTRATEGY
    MPD( AddSolverOption_MergeDuplicates("pre:cliquestrategy PRECLIQUESTRATEGY",
      "Determines how much effort to spend on clique covers in presolve."
      "\n\nDefault: -1",
      PRECLIQUESTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef PRECLIQUESTRATEGY

#ifdef PRECOEFELIM
    MPD( AddSolverOption_MergeDuplicates("pre:coefelim PRECOEFELIM",
      ...
      PRECOEFELIM, INT_MIN, INT_MAX) );
#endif  // ifdef PRECOEFELIM

#ifdef PRECOMPONENTS
    MPD( AddSolverOption_MergeDuplicates("pre:components PRECOMPONENTS",
      ...
      PRECOMPONENTS, INT_MIN, INT_MAX) );
#endif  // ifdef PRECOMPONENTS

#ifdef PRECOMPONENTSEFFORT
    MPD( AddSolverOption_MergeDuplicates("pre:componentseffort PRECOMPONENTSEFFORT",
      ...
      "\n\nDefault: 1.0",
      PRECOMPONENTSEFFORT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PRECOMPONENTSEFFORT

#ifdef PRECONEDECOMP
    MPD( AddSolverOption_MergeDuplicates("pre:conedecomp PRECONEDECOMP",
      ...
      PRECONEDECOMP, INT_MIN, INT_MAX) );
#endif  // ifdef PRECONEDECOMP

#ifdef PRECONFIGURATION
    MPD( AddSolverOption_MergeDuplicates("pre:configuration PRECONFIGURATION",
      ...
      PRECONFIGURATION, INT_MIN, INT_MAX) );
#endif  // ifdef PRECONFIGURATION

#ifdef PRECONVERTOBJTOCONS
    MPD( AddSolverOption_MergeDuplicates("pre:convertobjtocons PRECONVERTOBJTOCONS",
      ...
      PRECONVERTOBJTOCONS, INT_MIN, INT_MAX) );
#endif  // ifdef PRECONVERTOBJTOCONS

#ifdef PRECONVERTSEPARABLE
    MPD( AddSolverOption_MergeDuplicates("pre:convertseparable PRECONVERTSEPARABLE",
      ...
      PRECONVERTSEPARABLE, INT_MIN, INT_MAX) );
#endif  // ifdef PRECONVERTSEPARABLE

#ifdef PREDOMCOL
    MPD( AddSolverOption_MergeDuplicates("pre:domcol PREDOMCOL",
      ...
      PREDOMCOL, INT_MIN, INT_MAX) );
#endif  // ifdef PREDOMCOL

#ifdef PREDOMROW
    MPD( AddSolverOption_MergeDuplicates("pre:domrow PREDOMROW",
      ...
      PREDOMROW, INT_MIN, INT_MAX) );
#endif  // ifdef PREDOMROW

#ifdef PREDUPROW
    MPD( AddSolverOption_MergeDuplicates("pre:duprow PREDUPROW",
      ...
      PREDUPROW, INT_MIN, INT_MAX) );
#endif  // ifdef PREDUPROW

#ifdef PREELIMQUAD
    MPD( AddSolverOption_MergeDuplicates("pre:elimquad PREELIMQUAD",
      ...
      PREELIMQUAD, INT_MIN, INT_MAX) );
#endif  // ifdef PREELIMQUAD

#ifdef PREFOLDING
    MPD( AddSolverOption_MergeDuplicates("pre:folding PREFOLDING",
      ...
      "\n- (0)  Disabled."
      "\n- (1)  Enabled.",
      PREFOLDING, INT_MIN, INT_MAX) );
#endif  // ifdef PREFOLDING

#ifdef PREIMPLICATIONS
    MPD( AddSolverOption_MergeDuplicates("pre:implications PREIMPLICATIONS",
      ...
      PREIMPLICATIONS, INT_MIN, INT_MAX) );
#endif  // ifdef PREIMPLICATIONS

#ifdef PRELINDEP
    MPD( AddSolverOption_MergeDuplicates("pre:lindep PRELINDEP",
      ...
      PRELINDEP, INT_MIN, INT_MAX) );
#endif  // ifdef PRELINDEP

#ifdef PREOBJCUTDETECT
    MPD( AddSolverOption_MergeDuplicates("pre:objcutdetect PREOBJCUTDETECT",
      ...
      PREOBJCUTDETECT, INT_MIN, INT_MAX) );
#endif  // ifdef PREOBJCUTDETECT

#ifdef PREPERMUTE
    MPD( AddSolverOption_MergeDuplicates("pre:permute PREPERMUTE",
      ...
      PREPERMUTE, INT_MIN, INT_MAX) );
#endif  // ifdef PREPERMUTE

#ifdef PREPERMUTESEED
    MPD( AddSolverOption_MergeDuplicates("pre:permuteseed PREPERMUTESEED",
      ...
      "\n\nDefault: 1",
      PREPERMUTESEED, INT_MIN, INT_MAX) );
#endif  // ifdef PREPERMUTESEED

#ifdef PREPROBING
    MPD( AddSolverOption_MergeDuplicates("pre:probing PREPROBING",
      ...
      PREPROBING, INT_MIN, INT_MAX) );
#endif  // ifdef PREPROBING

#ifdef PREPROTECTDUAL
    MPD( AddSolverOption_MergeDuplicates("pre:protectdual PREPROTECTDUAL",
      ...
      PREPROTECTDUAL, INT_MIN, INT_MAX) );
#endif  // ifdef PREPROTECTDUAL

#ifdef PREROOTEFFORT
    MPD( AddSolverOption_MergeDuplicates("heur:prerooteffort PREROOTEFFORT",
      ...
      PREROOTEFFORT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PREROOTEFFORT

#ifdef PREROOTTHREADS
    MPD( AddSolverOption_MergeDuplicates("heur:prerootthreads PREROOTTHREADS",
      ...
      PREROOTTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef PREROOTTHREADS

#ifdef PREROOTWORKLIMIT
    MPD( AddSolverOption_MergeDuplicates("heur:prerootworklimit PREROOTWORKLIMIT",
      ...
      PREROOTWORKLIMIT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PREROOTWORKLIMIT

#ifdef PRESOLVE
    MPD( AddSolverOption_MergeDuplicates("pre:solve PRESOLVE",
      ...
      PRESOLVE, INT_MIN, INT_MAX) );
#endif  // ifdef PRESOLVE

#ifdef PRESOLVEMAXGROW
    MPD( AddSolverOption_MergeDuplicates("pre:solvemaxgrow PRESOLVEMAXGROW",
      ...
      "\n\nDefault: 0.1",
      PRESOLVEMAXGROW, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PRESOLVEMAXGROW

#ifdef PRESOLVEOPS
    MPD( AddSolverOption_MergeDuplicates("pre:solveops PRESOLVEOPS",
      ...
      "\n- (18)  No mod2 presolve.",
      PRESOLVEOPS, INT_MIN, INT_MAX) );
#endif  // ifdef PRESOLVEOPS

#ifdef PRESOLVEPASSES
    MPD( AddSolverOption_MergeDuplicates("pre:solvepasses PRESOLVEPASSES",
      "Number of reduction rounds to be performed in presolve"
      "\n\nDefault: 1",
      PRESOLVEPASSES, INT_MIN, INT_MAX) );
#endif  // ifdef PRESOLVEPASSES

#ifdef PRESORT
    MPD( AddSolverOption_MergeDuplicates("pre:sort PRESORT",
      ...
      PRESORT, INT_MIN, INT_MAX) );
#endif  // ifdef PRESORT

#ifdef PRICINGALG
    MPD( AddSolverOption_MergeDuplicates("lp:pricingalg PRICINGALG",
      ...
      PRICINGALG, INT_MIN, INT_MAX) );
#endif  // ifdef PRICINGALG

#ifdef PRIMALOPS
    MPD( AddSolverOption_MergeDuplicates("lp:primalops PRIMALOPS",
      ...
      PRIMALOPS, INT_MIN, INT_MAX) );
#endif  // ifdef PRIMALOPS

#ifdef PRIMALPERTURB
    MPD( AddSolverOption_MergeDuplicates("lp:primalperturb PRIMALPERTURB",
      ...
      "\n\nDefault: -1 — determined automatically. ",
      PRIMALPERTURB, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PRIMALPERTURB

#ifdef PRIMALUNSHIFT
    MPD( AddSolverOption_MergeDuplicates("lp:primalunshift PRIMALUNSHIFT",
      ...
      PRIMALUNSHIFT, INT_MIN, INT_MAX) );
#endif  // ifdef PRIMALUNSHIFT

#ifdef PSEUDOCOST
    MPD( AddSolverOption_MergeDuplicates("mip:pseudocost PSEUDOCOST",
      ...
      "\n\nDefault: 0.01",
      PSEUDOCOST, -DBL_MAX, DBL_MAX) );
#endif  // ifdef PSEUDOCOST

#ifdef PWLDUALREDUCTIONS
    MPD( AddSolverOption_MergeDuplicates("pre:pwldualreductions PWLDUALREDUCTIONS",
      ...
      PWLDUALREDUCTIONS, INT_MIN, INT_MAX) );
#endif  // ifdef PWLDUALREDUCTIONS

#ifdef PWLNONCONVEXTRANSFORMATION
    MPD( AddSolverOption_MergeDuplicates("pre:pwlnonconvextransformation PWLNONCONVEXTRANSFORMATION",
      ...
      PWLNONCONVEXTRANSFORMATION, INT_MIN, INT_MAX) );
#endif  // ifdef PWLNONCONVEXTRANSFORMATION

#ifdef QCCUTS
    MPD( AddSolverOption_MergeDuplicates("qp:qccuts QCCUTS",
      ...
      "\n\nDefault: -1 — determined automatically.",
      QCCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef QCCUTS

#ifdef QCROOTALG
    MPD( AddSolverOption_MergeDuplicates("pre:qcrootalg QCROOTALG",
      ...
      QCROOTALG, INT_MIN, INT_MAX) );
#endif  // ifdef QCROOTALG

#ifdef QSIMPLEXOPS
    MPD( AddSolverOption_MergeDuplicates("qp:qsimplexops QSIMPLEXOPS",
      ...
      QSIMPLEXOPS, INT_MIN, INT_MAX) );
#endif  // ifdef QSIMPLEXOPS

#ifdef QUADRATICUNSHIFT
    MPD( AddSolverOption_MergeDuplicates("qp:quadraticunshift QUADRATICUNSHIFT",
      ...
      QUADRATICUNSHIFT, INT_MIN, INT_MAX) );
#endif  // ifdef QUADRATICUNSHIFT

#ifdef RANDOMSEED
    MPD( AddSolverOption_MergeDuplicates("tech:randomseed RANDOMSEED",
      ...
      "\n\nDefault: 1",
      RANDOMSEED, INT_MIN, INT_MAX) );
#endif  // ifdef RANDOMSEED

#ifdef REFACTOR
    MPD( AddSolverOption_MergeDuplicates("mip:refactor REFACTOR",
      ...
      REFACTOR, INT_MIN, INT_MAX) );
#endif  // ifdef REFACTOR

#ifdef REFINEOPS
    MPD( AddSolverOption_MergeDuplicates("sol:refineops REFINEOPS",
      ...
      REFINEOPS, INT_MIN, INT_MAX) );
#endif  // ifdef REFINEOPS

#ifdef RELAXTREEMEMORYLIMIT
    MPD( AddSolverOption_MergeDuplicates("tech:relaxtreememorylimit RELAXTREEMEMORYLIMIT",
      ...
      "\n\nDefault: 0.1",
      RELAXTREEMEMORYLIMIT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef RELAXTREEMEMORYLIMIT

#ifdef RELPIVOTTOL
    MPD( AddSolverOption_MergeDuplicates("sim:relpivottol RELPIVOTTOL",
      ...
      "\n\nDefault: 1.0E-06",
      RELPIVOTTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef RELPIVOTTOL

#ifdef REPAIRINDEFINITEQ
    MPD( AddSolverOption_MergeDuplicates("qp:repairindefiniteq REPAIRINDEFINITEQ",
      ...
      "\n- (1)  Do not repair.",
      REPAIRINDEFINITEQ, INT_MIN, INT_MAX) );
#endif  // ifdef REPAIRINDEFINITEQ

#ifdef REPAIRINFEASMAXTIME
    MPD( AddSolverOption_MergeDuplicates("inf:repairinfeasmaxtime REPAIRINFEASMAXTIME",
      ...
      "\n- (n>0)  If an integer solution has been found, stop MIP search after n seconds, otherwise continue until an integer solution is finally found."
      "\n- (n<0)  Stop in LP or MIP search after n seconds.",
      REPAIRINFEASMAXTIME, INT_MIN, INT_MAX) );
#endif  // ifdef REPAIRINFEASMAXTIME

#ifdef REPAIRINFEASTIMELIMIT
    MPD( AddSolverOption_MergeDuplicates("inf:repairinfeastimelimit REPAIRINFEASTIMELIMIT",
      ...
      REPAIRINFEASTIMELIMIT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef REPAIRINFEASTIMELIMIT

#ifdef RESOURCESTRATEGY
    MPD( AddSolverOption_MergeDuplicates("tech:resourcestrategy RESOURCESTRATEGY",
      ...
      RESOURCESTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef RESOURCESTRATEGY

#ifdef RLTCUTS
    MPD( AddSolverOption_MergeDuplicates("qp:rltcuts RLTCUTS",
      ...
      RLTCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef RLTCUTS

#ifdef ROOTPRESOLVE
    MPD( AddSolverOption_MergeDuplicates("pre:rootpresolve ROOTPRESOLVE",
      ...
      ROOTPRESOLVE, INT_MIN, INT_MAX) );
#endif  // ifdef ROOTPRESOLVE

#ifdef SBBEST
    MPD( AddSolverOption_MergeDuplicates("mip:sbbest SBBEST",
      ...
      SBBEST, INT_MIN, INT_MAX) );
#endif  // ifdef SBBEST

#ifdef SBEFFORT
    MPD( AddSolverOption_MergeDuplicates("mip:sbeffort SBEFFORT",
      "Adjusts the overall amount of effort when using strong branching to select an infeasible MIP entity to branch on."
      "\n\nDefault: 1.0",
      SBEFFORT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef SBEFFORT

#ifdef SBESTIMATE
    MPD( AddSolverOption_MergeDuplicates("mip:sbestimate SBESTIMATE",
      ...
      SBESTIMATE, INT_MIN, INT_MAX) );
#endif  // ifdef SBESTIMATE

#ifdef SBITERLIMIT
    MPD( AddSolverOption_MergeDuplicates("mip:sbiterlimit SBITERLIMIT",
      "Number of dual iterations to perform the strong branching for each entity."
      "\n\nDefault: -1 — determined automatically.",
      SBITERLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef SBITERLIMIT

#ifdef SBSELECT
    MPD( AddSolverOption_MergeDuplicates("mip:sbselect SBSELECT",
      ...
      SBSELECT, INT_MIN, INT_MAX) );
#endif  // ifdef SBSELECT

#ifdef SCALING
    MPD( AddSolverOption_MergeDuplicates("num:scaling SCALING",
      ...
      SCALING, INT_MIN, INT_MAX) );
#endif  // ifdef SCALING

#ifdef SDPCUTSTRATEGY
    MPD( AddSolverOption_MergeDuplicates("qp:sdpcutstrategy SDPCUTSTRATEGY",
      ...
      SDPCUTSTRATEGY, INT_MIN, INT_MAX) );
#endif  // ifdef SDPCUTSTRATEGY

#ifdef SERIALIZEPREINTSOL
    MPD( AddSolverOption_MergeDuplicates("tech:serializepreintsol SERIALIZEPREINTSOL",
      ...
      SERIALIZEPREINTSOL, INT_MIN, INT_MAX) );
#endif  // ifdef SERIALIZEPREINTSOL

#ifdef SIFTING
    MPD( AddSolverOption_MergeDuplicates("lp:sifting SIFTING",
      ...
      "\n- (0)  Disable sifting."
      "\n- (1)  Enable sifting.",
      SIFTING, INT_MIN, INT_MAX) );
#endif  // ifdef SIFTING

#ifdef SIFTPASSES
    MPD( AddSolverOption_MergeDuplicates("lp:siftpasses SIFTPASSES",
      ...
      "\n\nDefault: 4",
      SIFTPASSES, INT_MIN, INT_MAX) );
#endif  // ifdef SIFTPASSES

#ifdef SIFTPRESOLVEOPS
    MPD( AddSolverOption_MergeDuplicates("lp:siftpresolveops SIFTPRESOLVEOPS",
      ...
      SIFTPRESOLVEOPS, INT_MIN, INT_MAX) );
#endif  // ifdef SIFTPRESOLVEOPS

#ifdef SIFTSWITCH
    MPD( AddSolverOption_MergeDuplicates("lp:siftswitch SIFTSWITCH",
      ...
      SIFTSWITCH, INT_MIN, INT_MAX) );
#endif  // ifdef SIFTSWITCH

#ifdef SLEEPONTHREADWAIT
    MPD( AddSolverOption_MergeDuplicates("sys:sleeponthreadwait SLEEPONTHREADWAIT",
      ...
      SLEEPONTHREADWAIT, INT_MIN, INT_MAX) );
#endif  // ifdef SLEEPONTHREADWAIT

#ifdef SOLTIMELIMIT
    MPD( AddSolverOption_MergeDuplicates("lim:soltimelimit SOLTIMELIMIT",
      ...
      SOLTIMELIMIT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef SOLTIMELIMIT

#ifdef SOSREFTOL
    MPD( AddSolverOption_MergeDuplicates("tol:sosreftol SOSREFTOL",
      ...
      "\n\nDefault: 1.0E-06",
      SOSREFTOL, -DBL_MAX, DBL_MAX) );
#endif  // ifdef SOSREFTOL

#ifdef SYMMETRY
    MPD( AddSolverOption_MergeDuplicates("pre:symmetry SYMMETRY",
      ...
      SYMMETRY, INT_MIN, INT_MAX) );
#endif  // ifdef SYMMETRY

#ifdef SYMSELECT
    MPD( AddSolverOption_MergeDuplicates("pre:symselect SYMSELECT",
      "Adjusts the overall amount of effort for symmetry detection."
      "\n\n"
      "Values (default: -1):\n"
      "\n- (0)  Search the whole matrix (otherwise the 0, 1 and -1 coefficients only)."
      "\n- (1)  Search all entities (otherwise binaries only).",
      SYMSELECT, INT_MIN, INT_MAX) );
#endif  // ifdef SYMSELECT

#ifdef THREADS
    MPD( AddSolverOption_MergeDuplicates("tech:threads THREADS",
      "The default number of threads used during optimization."
      "\n\n"
      "Values (default: -1):\n"
      "\n- (-1)  Determined automatically based on hardware configuration."
      "\n- (>0)  Number of threads to use.",
      THREADS, INT_MIN, INT_MAX) );
#endif  // ifdef THREADS

#ifdef TIMELIMIT
    MPD( AddSolverOption_MergeDuplicates("lim:timelimit TIMELIMIT",
      ...
      TIMELIMIT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef TIMELIMIT

#ifdef TRACE
    MPD( AddSolverOption_MergeDuplicates("pre:trace TRACE",
      ...
      "\n\nDefault: 0",
      TRACE, INT_MIN, INT_MAX) );
#endif  // ifdef TRACE

#ifdef TREECOMPRESSION
    MPD( AddSolverOption_MergeDuplicates("mip:treecompression TREECOMPRESSION",
      ...
      "\n\nDefault: 2",
      TREECOMPRESSION, INT_MIN, INT_MAX) );
#endif  // ifdef TREECOMPRESSION

#ifdef TREECOVERCUTS
    MPD( AddSolverOption_MergeDuplicates("mip:treecovercuts TREECOVERCUTS",
      ...
      "\n\nDefault: -1",
      TREECOVERCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef TREECOVERCUTS

#ifdef TREECUTSELECT
    MPD( AddSolverOption_MergeDuplicates("mip:treecutselect TREECUTSELECT",
      ...
      "\n- (18)  Strong Chvatal-Gomory cuts."
      "\n- (20)  Farkas cuts.",
      TREECUTSELECT, INT_MIN, INT_MAX) );
#endif  // ifdef TREECUTSELECT

#ifdef TREEDIAGNOSTICS
    MPD( AddSolverOption_MergeDuplicates("mip:treediagnostics TREEDIAGNOSTICS",
      ...
      TREEDIAGNOSTICS, INT_MIN, INT_MAX) );
#endif  // ifdef TREEDIAGNOSTICS

#ifdef TREEFILELOGINTERVAL
    MPD( AddSolverOption_MergeDuplicates("mip:treefileloginterval TREEFILELOGINTERVAL",
      ...
      "\n\nDefault: 60",
      TREEFILELOGINTERVAL, INT_MIN, INT_MAX) );
#endif  // ifdef TREEFILELOGINTERVAL

#ifdef TREEGOMCUTS
    MPD( AddSolverOption_MergeDuplicates("mip:treegomcuts TREEGOMCUTS",
      ...
      "\n\nDefault: -1",
      TREEGOMCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef TREEGOMCUTS

#ifdef TREEMEMORYLIMIT
    MPD( AddSolverOption_MergeDuplicates("tech:treememorylimit TREEMEMORYLIMIT",
      ...
      TREEMEMORYLIMIT, INT_MIN, INT_MAX) );
#endif  // ifdef TREEMEMORYLIMIT

#ifdef TREEMEMORYSAVINGTARGET
    MPD( AddSolverOption_MergeDuplicates("mip:treememorysavingtarget TREEMEMORYSAVINGTARGET",
      ...
      "\n\nDefault: 0.4",
      TREEMEMORYSAVINGTARGET, -DBL_MAX, DBL_MAX) );
#endif  // ifdef TREEMEMORYSAVINGTARGET

#ifdef TREEQCCUTS
    MPD( AddSolverOption_MergeDuplicates("qp:treeqccuts TREEQCCUTS",
      ...
      "\n\nDefault: -1 — determined automatically.",
      TREEQCCUTS, INT_MIN, INT_MAX) );
#endif  // ifdef TREEQCCUTS

#ifdef TUNERHISTORY
    MPD( AddSolverOption_MergeDuplicates("tech:tunerhistory TUNERHISTORY",
      ...
      TUNERHISTORY, INT_MIN, INT_MAX) );
#endif  // ifdef TUNERHISTORY

#ifdef TUNERMAXTIME
    MPD( AddSolverOption_MergeDuplicates("tech:tunermaxtime TUNERMAXTIME",
      ...
      TUNERMAXTIME, -DBL_MAX, DBL_MAX) );
#endif  // ifdef TUNERMAXTIME

#ifdef TUNERMETHOD
    MPD( AddSolverOption_MergeDuplicates("tech:tunermethod TUNERMETHOD",
      ...
      TUNERMETHOD, INT_MIN, INT_MAX) );
#endif  // ifdef TUNERMETHOD

#ifdef TUNERMETHODFILE
    MPD( AddSolverOption_MergeDuplicates("tech:tunermethodfile TUNERMETHODFILE",
      "Tuner: Defines a file from which the tuner can read user-defined tuner method."
      "\n\nDefault: (empty)",
      TUNERMETHODFILE) );
#endif  // ifdef TUNERMETHODFILE

#ifdef TUNERMODE
    MPD( AddSolverOption_MergeDuplicates("tech:tunermode TUNERMODE",
      ...
      TUNERMODE, INT_MIN, INT_MAX) );
#endif  // ifdef TUNERMODE

#ifdef TUNEROUTPUT
    MPD( AddSolverOption_MergeDuplicates("tech:tuneroutput TUNEROUTPUT",
      ...
      TUNEROUTPUT, INT_MIN, INT_MAX) );
#endif  // ifdef TUNEROUTPUT

#ifdef TUNEROUTPUTPATH
    MPD( AddSolverOption_MergeDuplicates("tech:tuneroutputpath TUNEROUTPUTPATH",
      "Tuner: Defines a root path to which the tuner writes the result file and logs."
      "\n\nDefault: tuneroutput",
      TUNEROUTPUTPATH) );
#endif  // ifdef TUNEROUTPUTPATH

#ifdef TUNERPERMUTE
    MPD( AddSolverOption_MergeDuplicates("tech:tunerpermute TUNERPERMUTE",
      ...
      TUNERPERMUTE, INT_MIN, INT_MAX) );
#endif  // ifdef TUNERPERMUTE

#ifdef TUNERSESSIONNAME
    MPD( AddSolverOption_MergeDuplicates("tech:tunersessionname TUNERSESSIONNAME",
      "Tuner: Defines a session name for the tuner."
      "\n\nDefault: (empty)",
      TUNERSESSIONNAME) );
#endif  // ifdef TUNERSESSIONNAME

#ifdef TUNERTARGET
    MPD( AddSolverOption_MergeDuplicates("tech:tunertarget TUNERTARGET",
      ...
      TUNERTARGET, INT_MIN, INT_MAX) );
#endif  // ifdef TUNERTARGET

#ifdef TUNERTHREADS
    MPD( AddSolverOption_MergeDuplicates("tech:tunerthreads TUNERTHREADS",
      ...
      TUNERTHREADS, INT_MIN, INT_MAX) );
#endif  // ifdef TUNERTHREADS

#ifdef TUNERVERBOSE
    MPD( AddSolverOption_MergeDuplicates("tech:tunerverbose TUNERVERBOSE",
      "Tuner: whether the tuner should prints detailed information for each run."
      "\n\n"
      "Values (default: 1):\n"
      "\n- (1)  Print extra information."
      "\n- (0)  Print less information.",
      TUNERVERBOSE, INT_MIN, INT_MAX) );
#endif  // ifdef TUNERVERBOSE

#ifdef USERSOLHEURISTIC
    MPD( AddSolverOption_MergeDuplicates("heur:usersolheuristic USERSOLHEURISTIC",
      ...
      "\n- (2)  Moderate effort."
      "\n- (3)  High effort.",
      USERSOLHEURISTIC, INT_MIN, INT_MAX) );
#endif  // ifdef USERSOLHEURISTIC

#ifdef VARSELECTION
    MPD( AddSolverOption_MergeDuplicates("mip:varselection VARSELECTION",
      ...
      VARSELECTION, INT_MIN, INT_MAX) );
#endif  // ifdef VARSELECTION

#ifdef VERSION
    MPD( AddSolverOption_MergeDuplicates("tech:version VERSION",
      "The Optimizer version number, e.g. 1301 meaning release 13.01."
      "\n\nDefault: Software version dependent",
      VERSION, INT_MIN, INT_MAX) );
#endif  // ifdef VERSION

#ifdef WORKLIMIT
    MPD( AddSolverOption_MergeDuplicates("tech:worklimit WORKLIMIT",
      ...
      WORKLIMIT, -DBL_MAX, DBL_MAX) );
#endif  // ifdef WORKLIMIT
