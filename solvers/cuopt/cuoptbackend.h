#ifndef MP_CUOPT_BACKEND_H_
#define MP_CUOPT_BACKEND_H_
...
class CuoptBackend :
    public FlatBackend< MIPBackend<CuoptBackend> >,
    public CuoptCommon
{
  using BaseBackend = FlatBackend< MIPBackend<CuoptBackend> >;
...
public:
  ...
  static const char* GetAMPLSolverName() { return "cuopt"; }
  ...
  * Get MIP dual bound
  **/
  // Implement to return the best dual bound value
...
protected:
  ...
  void WindupCUOPTSolve();

  void ReportResults() override;
  void ReportCUOPTResults();

  void ReportCUOPTPool();
  ...
  json* get_json_sol() const { return json_sol_; }
  void set_json_sol(json* json_sol) { json_sol_ = json_sol; }

  httplib::Client* get_client() { return client_; }
  void set_client(httplib::Client* client) { client_ = client; }
